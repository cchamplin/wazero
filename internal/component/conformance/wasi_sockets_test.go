...
// Package conformance: WASI sockets conformance tests are deferred.
...
// TestWASISocketsDeferredToSession1 stands in for the full WASI sockets suite.
func TestWASISocketsDeferredToSession1(t *testing.T) {
