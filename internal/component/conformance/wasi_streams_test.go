...
// Package conformance: WASI streams conformance tests are deferred.
...
// TestWASIStreamsDeferredToSession1 stands in for the full WASI streams suite.
func TestWASIStreamsDeferredToSession1(t *testing.T) {
