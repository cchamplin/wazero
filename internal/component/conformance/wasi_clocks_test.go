...
// Package conformance: WASI clocks conformance tests are deferred.
...
// TestWASIClocksDeferredToSession1 stands in for the full WASI clocks suite.
func TestWASIClocksDeferredToSession1(t *testing.T) {
