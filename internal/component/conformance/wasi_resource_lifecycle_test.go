...
// Package conformance: WASI resource-lifecycle tests are deferred.
...
// TestWASIResourceLifecycleDeferredToSession1 stands in for the full
// WASI resource-lifecycle suite.
func TestWASIResourceLifecycleDeferredToSession1(t *testing.T) {
