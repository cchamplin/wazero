...
// Package conformance: WASI random conformance tests are deferred.
...
// TestWASIRandomDeferredToSession1 stands in for the full WASI random suite.
func TestWASIRandomDeferredToSession1(t *testing.T) {
