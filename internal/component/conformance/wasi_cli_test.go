...
// Package conformance: WASI CLI conformance tests are deferred. The
...
// TestWASICLIDeferredToSession1 stands in for the full WASI CLI suite.
func TestWASICLIDeferredToSession1(t *testing.T) {
