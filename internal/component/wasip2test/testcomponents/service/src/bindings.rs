...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:example:service@0.1.0:service:encoded world"
)]
#[doc(hidden)]
...
req\x06\0\x08\x04\0\x07execute\x01\x09\x04\0\x1dexample:service/handler@0.1.0\x05\
\x05\x04\0\x1dexample:service/service@0.1.0\x04\0\x0b\x0d\x01\0\x07service\x03\0\
